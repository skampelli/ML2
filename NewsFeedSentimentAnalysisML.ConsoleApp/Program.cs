...
namespace NewsFeedSentimentAnalysisML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\skamp\source\repos\PricePredicitonUsingNewsFeed\NewsFeedReader\bin\Debug\newsfeed.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"News: {sampleData.News}");
