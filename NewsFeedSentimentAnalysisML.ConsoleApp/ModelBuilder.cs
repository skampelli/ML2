...
using NewsFeedSentimentAnalysisML.Model;
using Microsoft.ML.Trainers;

namespace NewsFeedSentimentAnalysisML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\skamp\source\repos\PricePredicitonUsingNewsFeed\NewsFeedReader\bin\Debug\newsfeed.tsv";
        private static string MODEL_FILEPATH = @"../../../../NewsFeedSentimentAnalysisML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("Date_tf", "Date")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("News_tf", "News"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Date_tf", "News_tf" }))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);

            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(new AveragedPerceptronTrainer.Options() { LearningRate = 0.5f, DecreaseLearningRate = true, L2Regularization = 0.3616646f, NumberOfIterations = 49, InitialWeightsDiameter = 0.2383751f, Shuffle = false, LabelColumnName = "sentiment", FeatureColumnName = "Features" });
